...
export default class HomepageInner extends React.Component {
    constructor(props) {
        super(props);
    }
        ...
        return (
            <div className="pricing py-5">
                <div className="container">
                    <div className="row h-100 align-items-center masthead">
                        <div className="col-12 text-center">
                            <h1 className="">Vertically Centered Masthead Content</h1>
                        ...
                        <div className="col-lg-4">
                            <div className="card mb-5 mb-lg-0">
                                <div className="card-body">
                                    ...
                                    <a href="#" className="btn btn-block buttonSubmit text-uppercase">Button</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4">
